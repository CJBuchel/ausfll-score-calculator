...
* @returns {any}
*/
module.exports.wasm_masterpiece_validate = function(answers) {
    const ret = wasm.wasm_masterpiece_validate(addHeapObject(answers));
...
* @returns {any}
*/
module.exports.wasm_masterpiece_score = function(answers) {
    const ret = wasm.wasm_masterpiece_score(addHeapObject(answers));
    return takeObject(ret);
};
...
const path = require('path').join(__dirname, 'ausfll_wasm_bg.wasm');
