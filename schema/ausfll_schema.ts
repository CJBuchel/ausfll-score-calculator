// To parse this data:
//
//   import { Convert, AusfllSchema } from "./file";
//
//   const ausfllSchema = Convert.toAusfllSchema(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface AusfllSchema {
...
export class Convert {
    public static toAusfllSchema(json: string): AusfllSchema {
        return cast(JSON.parse(json), r("AusfllSchema"));
    }

    public static ausfllSchemaToJson(value: AusfllSchema): string {
        return JSON.stringify(uncast(value, r("AusfllSchema")), null, 2);
    }
}
